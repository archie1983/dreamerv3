...
#                continue
            ...
            try:
                ...
                self.initial_path_length = self.nu.get_path_cost_to_target_point(cur_pos, self.current_target_point, self.reachable_positions)
...
#            self.initial_path_length = get_path_length(path, cur_pos)
    ...
    def get_current_path_length(self):
        try:
            ...
            cur_pos = self.rnc.get_agent_pos_and_rotation()
            self.current_path_length = self.nu.get_path_cost_to_target_point(cur_pos, self.current_target_point,
                                                                             self.reachable_positions)
        except ValueError as e:
            print(f"ERROR: {e}")
